...
class SolarConstraintSolver(component):
    """Evaluate protected-point sunlight before and after the design."""

    def RunScript(self, ProtectedPoints, DesignVolume, ContextBuildings, North, Latitude, Longitude, TimeZone, Year, Month, Day, StartHour, EndHour, TimeStep, MinimumContinuousMinutes, RequiredSunHours, ImpactTolerance, Run):
        try:
            return execute(
                ProtectedPoints,
                DesignVolume,
