...
class SolarVoxelOptimizer(component):
    """Remove voxels top-down until the sunlight requirement is met."""

    def RunScript(self, ProtectedPoints, Voxels, VoxelIDs, ColumnIDs, LayerIDs, ContextBuildings, North, Latitude, Longitude, TimeZone, Year, Month, Day, StartHour, EndHour, TimeStep, MinimumContinuousMinutes, RequiredSunHours, MaxIterations, Run):
        try:
            return execute(
                ProtectedPoints,
                Voxels,
